...
Fury 是一个面向 WoW Classic Era 的狂暴战决策辅助插件，目标是在实战中帮助你更稳定地逼近 DPS / TPS 最优操作。

## 核心功能

- 实时主技能建议：根据怒气、GCD、CD、目标血量与敌对目标数给出下一技能建议
- 泄怒建议：独立判断是否该用 `Heroic Strike` 或 `Cleave`
- DPS / TPS 模式切换：支持自动按姿态切换，也支持手动强制模式
- Debug 面板：展示推荐理由、候选打分、淘汰原因、命中率等
...
- `/Applications/World of Warcraft/_classic_era_/Interface/AddOns/Fury`
